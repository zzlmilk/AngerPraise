...
@interface XMBarcodeScannerView()
...
@implementation XMBarcodeScannerView
...
#pragma mark - 四个角
    ...
    ScanQR1View.image = [UIImage imageNamed:@"ScanQR1" inBundle:imageBundle compatibleWithTraitCollection:nil];
    ...
    ScanQR2View.image = [UIImage imageNamed:@"ScanQR2" inBundle:imageBundle compatibleWithTraitCollection:nil];
    ...
    ScanQR3View.image = [UIImage imageNamed:@"ScanQR3" inBundle:imageBundle compatibleWithTraitCollection:nil];
    ...
    ScanQR4View.image = [UIImage imageNamed:@"ScanQR4" inBundle:imageBundle compatibleWithTraitCollection:nil];
...
#pragma mark - 扫描横线
    ...
    UIImage *lineImage = [UIImage imageNamed:@"ff_QRCodeScanLine" inBundle:imageBundle compatibleWithTraitCollection:nil];
...
{
    XMBarcodeScannerView *scanView = [[self alloc]initWithMetadataObjectTypes:metaDataObjectTypes];
